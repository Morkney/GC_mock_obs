...
#--------------------------------------------------------------------------
data = np.genfromtxt('./GC_property_table.txt', unpack=True, skip_header=2, dtype=None)[GC_ID-1]
...
#--------------------------------------------------------------------------
profile_data = np.genfromtxt('./EDGE_profiles.txt', unpack=True, dtype=None)
